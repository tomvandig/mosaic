// To parse this data:
//
//   import { Convert, MosaicIndexFile } from "./file";
//
//   const mosaicIndexFile = Convert.toMosaicIndexFile(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MosaicIndexFile {
    componentTables: ComponentTableElement[];
    header:          MosaicIndexFileHeader;
    imports:         ImportElement[];
    sections:        SectionElement[];
}

export interface ComponentTableElement {
    filename: string;
    schema:   any;
    type:     Type;
}
...
export interface MosaicIndexFileHeader {
...
export class Convert {
    public static toMosaicIndexFile(json: string): MosaicIndexFile {
        return cast(JSON.parse(json), r("MosaicIndexFile"));
    }

    public static mosaicIndexFileToJson(value: MosaicIndexFile): string {
...
const typeMap: any = {
    ...
    "NodeElement": o([
        { json: "components", js: "components", typ: u(undefined, a(r("ComponentElement"))) },
        { json: "id", js: "id", typ: "" },
    ], false),
    "ComponentElement": o([
